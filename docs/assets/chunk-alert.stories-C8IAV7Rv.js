 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const N=[["path",{d:"M12 19h8",key:"baeox8"}],["path",{d:"m4 17 6-6-6-6",key:"1yngyt"}]],j=f("terminal",N),D=A("relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",{variants:{variant:{default:"bg-background text-foreground shadow-[0_3px_0_rgba(0,0,0,0.1)]",destructive:"border-destructive/50 text-destructive dark:border-destructive [&>svg]:text-destructive shadow-[0_3px_0_oklch(0.38_0.16_27)]"}},defaultVariants:{variant:"default"}}),a=c.forwardRef(({className:r,variant:t,...s},h)=>e.jsx("div",{ref:h,role:"alert",className:d(D({variant:t}),r),...s}));a.displayName="Alert";const i=c.forwardRef(({className:r,...t},s)=>e.jsx("h5",{ref:s,className:d("mb-1 font-medium leading-none tracking-tight",r),...t}));i.displayName="AlertTitle";const l=c.forwardRef(({className:r,...t},s)=>e.jsx("div",{ref:s,className:d("text-sm [&_p]:leading-relaxed",r),...t}));l.displayName="AlertDescription";a.__docgenInfo={description:"",methods:[],displayName:"Alert"};i.__docgenInfo={description:"",methods:[],displayName:"AlertTitle"};l.__docgenInfo={description:"",methods:[],displayName:"AlertDescription"};const E={title:"Components/Alert",component:a,tags:["autodocs"],argTypes:{variant:{control:"select",options:["default","destructive"]}}},o={render:()=>e.jsxs(a,{children:[e.jsx(j,{className:"h-4 w-4"}),e.jsx(i,{children:"Heads up!"}),e.jsx(l,{children:"You can add components to your app using the CLI."})]})},n={render:()=>e.jsxs(a,{variant:"destructive",children:[e.jsx(_,{className:"h-4 w-4"}),e.jsx(i,{children:"Error"}),e.jsx(l,{children:"Your session has expired. Please log in again."})]})};var p,m,u;o.parameters={...o.parameters,docs:{...(p=o.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => <Alert>
